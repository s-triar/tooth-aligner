...
#
    folder+"\\"+"ld_saved_de_pop10_iter1000_f05_cr07_no_candidate_v2.csv",
    folder+"\\"+"ld_saved_de_pop100_iter100_f05_cr07_no_candidate_v2.csv",
    folder+"\\"+"ld_saved_de_pop1000_iter10_f05_cr07_no_candidate_v2.csv"
        ...
        for tooth_type in landmark_constant[arch_type]:
            ...
            for landmark_type in landmark_constant[arch_type][tooth_type]:
                ...
                landmark_point = get_landmark_point(landmark_constant[arch_type][tooth_type][landmark_type],
                                                    ...
                                                    norm_center_tooth,
                                                    norm_vertices_tooth,
                                                    vertices_tooth, 'no_candidate' not in path_landmark_file)
...
df_res.to_csv("hasil_evaluation_ld_based_on_arch_popiter_ll.csv",encoding='utf-8')
df_res_ld.to_csv("hasil_evaluation_ld_based_on_ld_popiter_ll.csv",encoding='utf-8')
