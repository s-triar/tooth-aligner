...
def get_closest_possible_rotations_and_movements(tooth,spl, spl_flat,B, line_center, eigenvec,is_upper,is_standalone, A, destination_pts, max_chr=1, min_chr=-1, step_rot=1, step_move=0.5):
    error = 999999999
    rot_x=0
    rot_y=0
    rot_z=0
