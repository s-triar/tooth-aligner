def init_chromosome():
    population=[]
    n_tooth = 14
    # per gigi : n_roll, n_yaw, n_pitch, n_move_x, n_move_y, n_move_z
    
    

def minimize_function():
    # TODO save temporrary hasil perhitungan studi model
    # TODO Check point di teeth udah ganti apa tetep.
    # TODO hitung studi model baru
    # TODO komparasi hasil perhitungan studi model. selisihnya harus berkurang
