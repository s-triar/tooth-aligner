...
destinations_pts = get_destination_points(model4, spl, A, model4.right_left_vec)

destinations_pts_belt, destinations_pts_belt_gum = calculate_flat_plane_points_belt(model4, destinations_pts)
