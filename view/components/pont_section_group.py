...
class PontArchSection(QWidget):
    def __init__(self, anterior_total_tooth_material, p1_distance, m1_distance, p1_dist_calc, m1_dist_calc, *args, **kwargs) -> None:
        ...
        titik_dua = QLabel(':')
        layout.addWidget(label_p1_calc,2,0)
        layout.addWidget(titik_dua,2,1)
        layout.addWidget(d_p1_calc,2,2)
        titik_dua = QLabel(':')
        layout.addWidget(label_m1,3,0)
        layout.addWidget(titik_dua,3,1)
        layout.addWidget(d_m1,3,2)
        titik_dua = QLabel(':')
        layout.addWidget(label_m1_calc,4,0)
        layout.addWidget(titik_dua,4,1)
        layout.addWidget(d_m1_calc,4,2)
