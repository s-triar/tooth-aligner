...
from vedo import *
c1 = Cube()
c2 = c1.clone().c('violetsoal').alpha(0.5) # copy of c1
v = vector(0,0,1)
p = vector(1,0,0)  # axis passes through this point
c2.rotateX(20, around=(1,1,1))
c2.rotateY(20, around=(1,1,1))
c2.rotateZ(20, around=(1,1,1))
c3 = c1.clone().c('yellow')
c3.rotateY(20, around=(1,1,1))
c3.rotateZ(20, around=(1,1,1))
c3.rotateX(20, around=(1,1,1))
l = Line(-v+p, v+p).lw(3).c('red')
pt = Point(p)
vt = Point(p-v,c='yellow')
show(c1, l, c2, c3, pt, vt, axes=1).close()